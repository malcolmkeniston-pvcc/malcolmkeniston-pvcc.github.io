#Name: Malcolm Keniston
#Prog Purpose: This program demonstrates how to manipluate a list, including:
...
dogs = ["Sadie","Molly","Ella","Milo","Rocky","AnnaBelle",
...
def main():
    ...
    print ("\nNote : Position numbers in a list begin with 0, no with 1")
    ...
    for i in range (len(dogs)):
        dogs[i] = dogs[i] + "Stevens" #Change Stevens to Keniston
    print (dogs)
